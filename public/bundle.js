...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  handleSearch: function handleSearch(loaction) {
	    var that = this;
	    debugger;
	  ...
	  render: function render() {
	    ...
	    function renderMessage() {
	      if (isLoading) {
	        ...
	        return React.createElement(Message, { temp: temp, loaction: loaction });
	      }
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          null,
	          React.createElement('input', { type: 'text', ref: 'loaction', placeholder: 'type the city name here' })
	        ),
	        React.createElement(
	          'button',
	          { type: 'submit' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_ERATHRT_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=87167c157267d2cd36694806535bfcf9&units=imperial';

	module.exports = {
	  getTemp: function getTemp(loaction) {
